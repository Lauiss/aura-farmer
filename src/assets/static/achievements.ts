...
export function createAchievements(
  ...
  const achievements: Achievement[] = [
    ...
    },
    {
      ...
      description: "Vaincre Chimpanzini Bananini en battle d'aura.",
      icon: "assets/imgs/achievements/trophy_achievement.png",
      condition: () => isBossDefeated('chimpanzini'),
      unlocked: false,
    },
    {
      id: 112,
      title: "Serré, sans Sucre",
      description: "Vaincre Cappuccino Assassino en battle d'aura.",
      icon: "assets/imgs/achievements/trophy_achievement.png",
      condition: () => isBossDefeated('cappuccino'),
      unlocked: false,
    },
    {
      id: 113,
      title: "Pas de Deux",
      description: "Vaincre Ballerina Cappuccina en battle d'aura.",
      icon: "assets/imgs/achievements/trophy_achievement.png",
      condition: () => isBossDefeated('ballerina'),
      unlocked: false,
    },
    {
      id: 110,
